...
import {View, Text, StyleSheet, Image, ScrollView, Dimensions, TextInput, TouchableOpacity, ImageBackground} from 'react-native';
  ...
  return(
    ...
    >
      ...
      <View style={{alignItems: 'center'}}>
        ...
        <Text style={{...styles.headingText, color: colors.colorPrimary}}>Services</Text>
      </View>
